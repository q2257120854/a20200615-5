            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td><?php echo get_sys('site_company'); ?>
                        <a href="http://www.yunziyuan.com.cn" class='x-a' target="_blank">访问官网</a></td>
                </tr>
                <tr>
                    <th>开发者</th>
                    <td>云资源(admin@wlxiu.cn)</td></tr>
                </tbody>
            </table>
        </div>
    </fieldset>
    <blockquote class="layui-elem-quote layui-quote-nm">本系统由云资源提供技术支持。</blockquote>
</div>
</body>
