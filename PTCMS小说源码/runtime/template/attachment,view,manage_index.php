        ...
        <form method = "post" action = "<?php echo  __URL__;?>/multi" id="showtable">
            ...
            <table class = "pt-list-table">
                ...
                <tr>
                    ...
                    <th>文件名</th>
                    <th class = "w-word3">类型</th>
                    <th class = "w-word5">大小</th>
                    <th class = "w-word5">上传人</th>
                    <th class = "w-time">上传时间</th>
                ...
                <tr ng-repeat = "loop in lists">
                    ...
                    <td class="f-tal"><a ng-href="{{loop.url}}" target="_blank">{{loop.name}}</a></td>
                    <td>{{loop.ext}}</td>
                    <td>{{loop.size}}</td>
                    <td>{{loop.create_username}}</td>
                    <td>{{loop.create_time}}</td>
                    <td class = "operate">
                        <a ng-href = "{{loop.url}}" target="_blank"><i class = "icon icon-search"></i>查看</a>
