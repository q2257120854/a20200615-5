        ...
        <form method = "post" action = "<?php echo  __URL__;?>/multi" id="showtable">
            ...
            <table class = "pt-list-table">
                ...
                <tr>
                    ...
                    <th class = "f-tal">规则名称</th>
                    <th class = "f-tal" style = "width:100px">所属站点</th>
                ...
                <tr ng-repeat = "loop in lists | filter:keyword">
                    ...
                    <td class = "f-tal">{{loop.sitename}}</td>
                    ...
                    <td class = "operate">
                        ...
                        <a ng-href = "{{loop.url_run}}"><i class = "icon icon-play"></i>采集</a>
                        <a ng-href = "{{loop.url_test}}"><i class = "icon icon-search"></i>测试</a>
