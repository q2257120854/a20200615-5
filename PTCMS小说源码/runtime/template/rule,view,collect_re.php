...
<div class = "pt-main-wrap">
    ...
    <form action="<?php echo __SELF__;?>" method="post" enctype="multipart/form-data" class="vform">
        <h4 class="pt-msg-title"><b class="f-fl">内容重采</b></h4>
            ...
            <div class="pt-set-content">
                ...
                <div class="pt-set-info">
                    <div class="line">
                        ...
                        <span class="Validform_checktip">仅可以使用勾选“更新其他站点采集到的小说信息”的规则</span>
                    </div>
                </div>
                <div class="pt-set-info">
                    <div class="line"><b>章节限制：</b>
                        <label>
                            <input name="chapter" type="radio" value="0" checked />所有章节
                        </label>
                        <label>
                            <input name="chapter" type="radio" value='1' />指定时间
                        </label>
                    </div>
                </div>
                <div class="pt-set-info chapter chapter1">
                    <div class="line">
                        <b>起始时间：</b>
                        <label><input name="chapterstarttime" type="text" value="" class="input-text w450 datetime" placeholder="不选为不限制，建议选择" /></label>
                    </div>
                </div>
                <div class="pt-set-info chapter chapter1">
                    <div class="line">
                        <b>截止时间：</b>
                        <label><input name="chapterendtime" type="text" value="" class="input-text w450 datetime" placeholder="不选为不限制，建议选择" /></label>
                    </div>
                </div>
            </div>
