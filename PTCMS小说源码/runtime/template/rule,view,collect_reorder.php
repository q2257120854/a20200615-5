...
<div class = "pt-main-wrap">
    ...
    <form action="<?php echo __SELF__;?>" method="post" enctype="multipart/form-data" class="vform">
        <h4 class="pt-msg-title"><b class="f-fl">章节重排</b></h4>
            ...
            <div class="pt-set-content">
                ...
                <div class="pt-set-info">
                    <div class="line">
                        <b>基准规则一：</b>
                        <label>
                            <select class="input-box w450" name="ruleid1">
                ...
                <div class="pt-set-info">
                    <div class="line">
                        <b>基准规则二：</b>
                        <label>
                            <select class="input-box w450" name="ruleid2">
                                <option value="0">请选择备用站点</option>
                                <?php if(is_array($rulelist)): foreach($rulelist as $key =>$loop):?>
                                <option value="<?php echo $loop['id'];?>"><?php echo $loop['name'];?></option>
                                <?php endforeach; endif;?>
                            </select>
                ...
                <div class="pt-set-info">
                    <div class="line">
                        <b>基准规则三：</b>
                        <label>
                            <select class="input-box w450" name="ruleid3">
                                <option value="0">请选择备用站点</option>
                                <?php if(is_array($rulelist)): foreach($rulelist as $key =>$loop):?>
                                <option value="<?php echo $loop['id'];?>"><?php echo $loop['name'];?></option>
                                <?php endforeach; endif;?>
