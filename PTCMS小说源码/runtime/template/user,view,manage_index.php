        ...
        <form method = "post" action = "<?php echo  __URL__;?>/multi" id="showtable">
            ...
            <table class = "pt-list-table">
                ...
                <tr>
                    ...
                    <th>用户名</th>
                    <th style="width:150px;">登录IP</th>
                    <th class = "w-fulltime">登录时间</th>
                    <th style="width:150px;">注册IP</th>
                    <th class = "w-fulltime">注册时间</th>
                ...
                <tr ng-repeat = "loop in lists">
                    ...
                    <td class = "operate">
                        <a ng-href = "{{loop.url_mark}}" target="_blank"><i class = "icon icon-book"></i>书架</a>
