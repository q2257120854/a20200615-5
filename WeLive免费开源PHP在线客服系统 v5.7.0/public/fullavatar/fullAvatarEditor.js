function fullAvatarEditor() {
	...
	var file			= baseurl+'public/fullavatar/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= baseurl+'public/fullavatar/expressInstall.swf';		//expressInstall.swf的路径
