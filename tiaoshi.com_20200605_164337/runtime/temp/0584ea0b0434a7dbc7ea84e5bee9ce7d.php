       ...
       <div class="col-xl-3 col-sm-6 mb-3"> 
        <div class="video-card"> 
         <div class="video-card-image"> 
          <a target="_blank" class="play-icon" href="<?php echo mac_url_vod_play($vo); ?>"><i class="fa fa-play-circle"></i></a> 
         ...
         <div class="video-card-body"> 
          ...
          <div class="video-page text-success"> 
           ...
           <a title="" data-placement="top" data-toggle="tooltip" href="<?php echo mac_url_type($vo['type']); ?>" data-original-title="精选内容"><i class="fa fa-check-circle text-success"></i></a> 
          </div> 
