...
<div class="fed-main-info fed-min-width">
  <div class="fed-part-case">
    <div class="fed-user-head fed-margin-top fed-back-whits">
      <div class="fed-list-pics fed-lazy fed-part-5by2 fed-part-rows" style="background:url(<?php echo $maccms['site_wapurl']; ?>html/style/images/user.jpg);">
        <div class="fed-part-core fed-text-center">
          <div class="fed-user-image" data-role="<?php echo mac_url('user/portrait'); ?>"> <img class="face fed-user-avat fed-part-roun" src="<?php echo mac_url_img(mac_default($obj['user_portrait'],'static/images/touxiang.png')); ?>?v=<?php echo time(); ?>" /> </div>
          <span class="fed-visible fed-text-white fed-padding"><?php echo $obj['user_name']; ?></span> </div>
      </div>
    ...
    <div class="fed-part-rows">
      <div class="fed-main-left fed-col-xs12 fed-col-md4 fed-col-lg3 fed-hide-xs fed-hide-sm fed-show-md-block"> <div class="fed-part-layout fed-back-whits fed-margin-right fed-hide-xs fed-hide-sm fed-show-md-block">
  <ul class="fed-user-brief fed-part-rows fed-back-whits">
    <li class="fed-padding-x fed-text-center fed-col-xs4"> <span class="fed-visible fed-text-gules"><?php echo $obj['user_points']; ?></span> <span class="fed-visible">我的积分</span> </li>
    <li class="fed-padding-x fed-text-center fed-line-left fed-col-xs4"> <span class="fed-visible fed-text-gules"><?php echo $obj['group']['group_name']; ?></span> <span class="fed-visible">我的等级</span> </li>
    <li class="fed-padding-x fed-text-center fed-line-left fed-col-xs4"> <span class="fed-visible fed-text-gules"><?php echo $obj['user_login_num']; ?></span> <span class="fed-visible">登录次数</span> </li>
      ...
      <div class="fed-main-right fed-col-xs12 fed-col-md8 fed-col-lg9">
        <div class="fed-part-layout fed-back-whits">
          <div class="fed-user-title fed-list-head fed-part-rows fed-padding fed-line-bottom">
            <h2 class="fed-font-xvi fed-padding">兑换区</h2>
            <ul class="fed-part-tips fed-padding">
			<li class="fed-padding fed-btns-green" type="button"> <a href="<?php echo mac_url('user/index'); ?>" target="_blank">我要去推广</a> </li>
              <li class="fed-padding fed-btns-green" type="button"> <a href="<?php echo mac_url('user/buy'); ?>" target="_blank">在线充值</a> </li>
          ...
          <form class="fed-user-form fed-user-info fed-part-rows" action="<?php echo mac_url('user/upgrade'); ?>">
            <ul class="fed-user-list fed-part-rows fed-back-whits">
              <li class="fed-padding-x fed-part-rows fed-line-bottom">
                <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> <span class="fed-col-xs4 fed-col-sm3 fed-part-eone">当前会员组</span> <span class="fed-col-xs6 fed-col-sm6 fed-part-eone"><?php echo $obj['group']['group_name']; ?></span> <span class="fed-col-xs2 fed-col-sm3 fed-part-eone fed-text-right"><i class="fed-icon-font fed-icon-you"></i></span> </div>
              </li>
              <li class="fed-padding-x fed-part-rows fed-line-bottom">
                <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> <span class="fed-col-xs4 fed-col-sm3 fed-part-eone">小提示:</span> <span class="fed-col-xs6 fed-col-sm6 fed-part-eone">推广注册送VIP！</span> <span class="fed-col-xs2 fed-col-sm3 fed-part-eone fed-text-right"><i class="fed-icon-font fed-icon-you"></i></span> </div>
              </li>
              ...
              <li class="fed-padding-x fed-part-rows fed-line-bottom">
                <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> <a class="fed-subm-group fed-col-xs12 fed-col-sm12 fed-part-eone grade" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_month']; ?>" data-long="month"><span class="fed-padding-x fed-btns-info fed-btns-green fed-col-xs12">激活 ☀(31天)☀VIP <?php echo $vo['group_points_month']; ?>积分(需推广18人) </span> </a> </div>
              </li>
              <li class="fed-padding-x fed-part-rows fed-line-bottom">
                <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> <a class="fed-subm-group fed-col-xs12 fed-col-sm12 fed-part-eone grade" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_quarter']; ?>" data-long="quarter"><span class="fed-padding-x fed-btns-info fed-btns-green fed-col-xs12">激活 ☀(100天)☀VIP <?php echo $vo['group_points_quarter']; ?>积分(需推广45人)</span> </a> </div>
              </li>
              <li class="fed-padding-x fed-part-rows fed-line-bottom">
                <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> <a class="fed-subm-group fed-col-xs12 fed-col-sm12 fed-part-eone grade" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_year']; ?>" data-long="year"><span class="fed-padding-x fed-btns-info fed-btns-green fed-col-xs12">激活 ☀(365天)☀VIP <?php echo $vo['group_points_year']; ?>积分(需推广118人)</span> </a> </div>
              </li>
              </li>
              <li class="fed-padding-x fed-part-rows fed-line-bottom">
                <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> <a class="fed-subm-group fed-col-xs12 fed-col-sm12 fed-part-eone grade" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_along']; ?>" data-long="along"><span class="fed-padding-x fed-btns-info fed-btns-green fed-col-xs12">激活 ☀永久至尊☀VIP <?php echo $vo['group_points_along']; ?>积分(需推广198人)</span> </a> </div>
              </li>
        ...
        <div class="donation_thumbnail">
          <p class="secTitle">请立即激活VIP特权，万余名AV女优在等您！</p>
