<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"template/RX03/new1685/user/login.html";i:1576940018;s:61:"/www/wwwroot/tiaoshi.com/template/RX03/new1685/user/foot.html";i:1577472541;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<section class="login-main-wrapper">
  <div class="container-fluid pl-0 pr-0">
    <div class="row no-gutters"> <a class="gohome" href="/">首页</a>
      <div class="col-md-5 p-5 bg-white full-height">
        <div class="login-main-left">
          ...
          <div class="fr mt-2"> <a href="<?php echo url('user/findpass_msg'); ?>?ac=email"> 忘记密码? </a> </div>
          <div class="text-center mt-5">
            <p class="light-gray"> 还不是会员? <a href="<?php echo url('user/reg'); ?>"> 立即注册 </a> </p>
          </div>
        </div>
      </div>
      <div class="col-md-7 slide2">
        <div class="login-main-right bg-white p-5 mt-5 mb-5">
          <div class="owl-carousel owl-carousel-login">
            <div class="item">
              <div class="carousel-login-card text-center"> <img src="<?php echo $maccms['site_wapurl']; ?>html/style/images/recharge_loading_bg.png" width="75%" class="img-fluid"
                    alt="LOGO">
            ...
            <div class="item">
              <div class="carousel-login-card text-center"> <img src="<?php echo $maccms['site_wapurl']; ?>html/style/images/loading_empty.png" width="75%" class="img-fluid"
                    alt="LOGO">
