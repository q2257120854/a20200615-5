      ...
      <div class="fed-part-layout fed-back-whits"> 
       ...
       <ul class="fed-user-list fed-part-rows fed-back-whits"> 
        ...
        <li class="fed-padding-x fed-part-rows"> 
         <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
          <span class="fed-col-xs4 fed-col-sm3 fed-part-eone">推广注册连接</span> 
          <span class="fed-col-xs7 fed-col-sm8 fed-part-eone"><input id="url" class="fed-visible" value="<?php echo $maccms['site_url']; ?>/index.php/vod/type/id/20.html?tg_uid=<?php echo $obj['user_id']; ?>" /></span> 
          <span class="fed-col-xs1 fed-col-sm1 fed-part-eone fed-text-right"><i class="fed-icon-font fed-icon-you"></i></span> 
         </div> </li> 
       </ul> 
      </div> 
