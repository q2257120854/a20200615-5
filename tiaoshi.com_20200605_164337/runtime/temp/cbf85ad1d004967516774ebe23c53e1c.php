<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"template/RX03/new1685/user/findpass_msg.html";i:1576939921;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
            ...
            <div class="login-main-left">
              ...
              <form method="post" id="fm" action="">
                ...
                <div class="form-group">
                  <label>
                    <?php echo $param['ac_text']; ?>
                  </label>
                  <input type="text" id="to" name="to" class="form-control" placeholder="请输入您绑定的<?php echo $param['ac_text']; ?>" value="" autofocus required>
                </div>
				<div class="form-group">
				  <label>
                    验证码
                ...
                <div class="mt-4">
                  <div class="row">
                    <div class="col-12">
                      <input type="button" id="btn_send" class="btn btn-outline-primary btn-block btn-lg" value="发送验证码">
                    </div>
                  </div>
                </div>
              </form>
			  
			  <form method="post" id="fm2" class="mt-4" action="">
				<input type="hidden" name="ac" value="email">
				<div class="form-group">
				  <label>
                    <?php echo $param['ac_text']; ?>验证码
                  </label>
                ...
                <div class="form-group">
                  ...
                  <input type="password" id="user_pwd" name="user_pwd" class="form-control" placeholder="请输入新密码" required>
                </div>
				<div class="form-group">
                  <label>
                    确认密码
                  </label>
                  <input type="password" id="user_pwd2" name="user_pwd2" class="form-control" placeholder="请输入确认密码" required>
                </div>
                <div class="mt-4">
                  <div class="row">
                    <div class="col-12">
                      <input type="button" id="btn_submit" class="btn btn-outline-primary btn-block btn-lg" value="重置密码">
                    </div>
                  </div>
                </div>
              </form>
