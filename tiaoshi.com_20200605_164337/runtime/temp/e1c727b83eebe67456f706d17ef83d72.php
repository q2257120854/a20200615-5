...
<html>
 <head> 
  ...
  <title>三级分销 - 个人中心 - <?php echo $maccms['site_name']; ?></title> 
...
<div class="fed-main-right fed-col-xs12 fed-col-md8 fed-col-lg9"> 
      <div class="fed-part-layout fed-back-whits"> 
       <div class="fed-user-title fed-list-head fed-part-rows fed-padding fed-line-bottom"> 
             <h2 class="fed-font-xvi fed-padding"><a class="fed-text-green fed-more" href="<?php echo url('user/reward'); ?>">一级下线</a>&nbsp;&nbsp;<a class="fed-more"  href="<?php echo url('user/reward'); ?>?level=2" >二级下线</a>&nbsp;&nbsp;<a  class="fed-more"  href="<?php echo url('user/reward'); ?>?level=3">三级下线</a></h2> 
      ...
      <ul class="fed-user-list fed-part-rows fed-back-whits"> 
        <li class="fed-padding-x fed-part-rows"> 
         <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
          <span class="fed-col-xs4 fed-col-sm4 fed-part-eone">编号</span> 
          <span class="fed-col-xs4 fed-col-sm4 fed-part-eone">会员</span> 
          <span class="fed-col-xs4 fed-col-sm4 fed-part-eone fed-text-right">时间</span>  
         </div> </li>  
         <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <li class="fed-padding-x fed-part-rows fed-line-top"> 
         <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
          <span class="fed-col-xs4 fed-col-sm4 fed-part-eone"><?php echo $vo['user_id']; ?></span> 
          <span class="fed-col-xs4 fed-col-sm4 fed-part-eone"><?php echo $vo['user_name']; ?></span> 
          <span class="fed-col-xs4 fed-col-sm4 fed-part-eone fed-text-right"><?php echo mac_day($vo['user_reg_time']); ?></span> 
         </div> </li>  
        <?php endforeach; endif; else: echo "" ;endif; ?>
