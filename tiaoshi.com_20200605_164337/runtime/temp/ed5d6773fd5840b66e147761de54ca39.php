<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/www/wwwroot/tiaoshi.com/application/admin/view/user/info.html";i:1588770024;s:64:"/www/wwwroot/tiaoshi.com/application/admin/view/public/head.html";i:1552720680;s:64:"/www/wwwroot/tiaoshi.com/application/admin/view/public/foot.html";i:1552720680;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    ...
    <form class="layui-form layui-form-pane" method="post" action="">
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" value="<?php echo $info['code']; ?>" placeholder="" id="user_name" name="code">
            </div>
        </div>
      <?php if($info['group_id'] == 5): ?> 
      	<div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" value="<?php echo $info['user_tc']; ?>" placeholder="" id="user_tc" name="user_tc">
            </div>
        </div>
      <?php endif; ?>
        <div class="layui-form-item">
