...
<meta name="author" content="<?php echo $obj['type_key']; ?>-<?php echo $maccms['site_name']; ?>" />
<!-- Favicon Icon -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="main-title">
              ...
              <div class="single-video-title box mb-3"> <small><a href="/index.php/user/buy.html" class="external"><img src="/template/RX03/images/gg1.png" width="100%" height="80%"></a></small> </div>
            </div>
          </div>
          <?php $__TAG__ = '{"num":"12","paging":"yes","pageurl":"vod\/type","order":"desc","by":"level","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
          <div class="col-xl-3 col-sm-6 mb-3 video-xz">
            <div class="video-card">
              <div class="video-card-image"> <a target="_blank" class="play-icon" href="<?php echo mac_url_vod_play($vo); ?>"><i class="fas fa-play-circle"></i></a> <a target="_blank" href="<?php echo mac_url_vod_play($vo); ?>"> <img class="img-fluid lazy1" src="<?php echo mac_url_img($vo['vod_pic']); ?>" alt="<?php echo $vo['vod_name']; ?>" data-original="<?php echo mac_url_img($vo['vod_pic']); ?>" /> </a>
                <div class="time"> <?php echo $obj['type_name']; ?> </div>
              </div>
              <div class="video-card-body">
                <div class="video-title"> <a target="_blank" href="<?php echo mac_url_vod_play($vo); ?>"><?php echo $vo['vod_name']; ?></a> </div>
                <div class="video-page text-success"> <?php echo $obj['type_name']; ?> <a title="" data-placement="top" data-toggle="tooltip" href="<?php echo mac_url_type($vo['type']); ?>" data-original-title="精选内容"><i class="fa fa-check-circle text-success"></i></a> </div>
