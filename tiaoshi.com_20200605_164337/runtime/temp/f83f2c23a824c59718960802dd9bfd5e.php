...
<html>
 <head> 
  ...
  <title>订单记录 - 个人中心 - <?php echo $maccms['site_name']; ?></title> 
     ...
     <div class="fed-main-right fed-col-xs12 fed-col-md8 fed-col-lg9"> 
      <div class="fed-part-layout fed-back-whits"> 
       <div class="fed-user-title fed-list-head fed-part-rows fed-padding fed-line-bottom"> 
        <h2 class="fed-font-xvi fed-padding"><a class="fed-text-green fed-more" href="<?php echo mac_url('user/orders'); ?>">在线充值记录</a>&nbsp;&nbsp;<a class="fed-more" href="<?php echo mac_url('user/cards'); ?>">充值卡记录</a></h2> 
       ...
       <ul class="fed-user-list fed-part-rows fed-back-whits"> 
        <li class="fed-padding-x fed-part-rows"> 
         <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
          <span class="fed-col-xs3 fed-col-sm1 fed-part-eone">状态</span> 
          <span class="fed-col-xs4 fed-col-sm4 fed-part-eone">单号</span> 
          <span class="fed-col-xs3 fed-col-sm1 fed-part-eone fed-text-right">金额</span> 
          <span class="fed-hide-xs fed-col-sm1 fed-part-eone fed-text-right">积分</span> 
          <span class="fed-hide-xs fed-col-sm4 fed-part-eone fed-text-right">时间</span> 
          <span class="fed-col-xs2 fed-col-sm1 fed-part-eone fed-text-right">操作</span> 
         </div> </li> <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> 
        <li class="fed-padding-x fed-part-rows fed-line-top"> 
         <div class="fed-user-input fed-visible fed-font-xvi fed-part-rows"> 
          <span class="fed-col-xs3 fed-col-sm1 fed-part-eone"><?php if($vo['order_status'] == 1): ?>已支付<?php else: ?>未支付<?php endif; ?></span> 
          <span class="fed-col-xs4 fed-col-sm4 fed-part-eone"><?php echo $vo['order_code']; ?></span> 
          <span class="fed-col-xs3 fed-col-sm1 fed-part-eone fed-text-right"><?php echo $vo['order_price']; ?></span> 
          <span class="fed-hide-xs fed-col-sm1 fed-part-eone fed-text-right"><?php echo $vo['order_points']; ?></span> 
          <span class="fed-hide-xs fed-col-sm4 fed-part-eone fed-text-right"><?php echo mac_day($vo['order_time']); ?></span> 
          <span class="fed-col-xs2 fed-col-sm1 fed-part-eone fed-text-right"><?php if($vo['order_status']==0): ?><a href="<?php echo mac_url('user/pay'); ?>?order_code=<?php echo $vo['order_code']; ?>">支付</a><?php endif; ?></span> 
         </div> </li> <?php endforeach; endif; else: echo "" ;endif; if($__PAGING__['page_total']>1): ?> 
