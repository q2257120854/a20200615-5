...
?>
<!-- 
本程序由SAF团队-逸轩(QQ570602783)开发并持续更新，商用请购买正版，购买后可后台在线更新,正版用户不可删除此处版权，否则将不予更新！
 -->
<!DOCTYPE html>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="header-navbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="http://bbs.xinmazhan.com">新码云资源</a> </li>
                        <li><a href="http://paibao88.com">新码商城</a></li>
                        <li><a href="http://www.5g-yun.com">香港永久空间</a></li>
                        <li><a href="http://www.5g-yun.com">景安快云</a></li>
                        <li class="active"><a href="http://php.xinmazhan.com">新码云加密</a></li>
                      <!--
                        <li class="dropdown">
...
<p>URL地址：http://<?php echo $conf['local_domain']?>/api.php?act=settle&amp;pid={商户ID}&amp;key={商户密钥}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<p>URL地址：http://<?php echo $conf['local_domain']?>/api.php?act=orders&amp;pid={商户ID}&amp;key={商户密钥}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
SDK版本：V1.1
        ...
        <div id="footer" class="footer">
            <div class="container">
                ...
                <p>
                    Copyright &copy; 2017-2019 <a href="http://www.yunziyuan.com.cn/21062.html" target="_blank"><?php echo $conf['web_name'];?></a> 版权所有. <br />
                </p>
            </div>
        </div>
        <!-- end #footer -->
