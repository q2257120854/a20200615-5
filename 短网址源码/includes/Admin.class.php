  ...
  private function setUpExtended(){
    ...
    if(isset($_POST["token"])){
      ...
      if(!$Resp || empty($Resp) || $Resp == "Failed"){
        ...
        return Main::redirect("admin/subscription",array("danger","This purchase code is for another item. Please use a 5G云短网址系统 extended license purchase code.")); 
      }elseif($Resp == "Wrong.License"){
        return Main::redirect("admin/subscription",array("danger","This purchase code is for a standard license. Please use a 5G云短网址系统 extended license purchase code.")); 
      }else{
