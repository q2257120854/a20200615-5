...
define('YDF_URL','http://api.yundaifu.com//api/api/withdraw');
define('YDF_OPENID_URL','http://api.yundaifu.com/api/api/getOpenid');

define("FAST_APPKEY", "13222_5d41cf7a8adab284353a0149cc0e6769");//你的appkey
define("SECRET_KEY", "2838f4e79269d1cf31a11752f22f92cc");//你的秘钥
