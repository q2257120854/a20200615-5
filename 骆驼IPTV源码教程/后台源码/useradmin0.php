...
$result=mysql_query("select adtext from chzb_appdata");
if($row=mysql_fetch_array($result)){
	$adtext=$row['adtext'];
	$userpsw=$row['userpsw'];
}else{
...
<table border="1" bordercolor="#a0c6e5" style="border-collapse:collapse;">
	...
	<tr><td width=100><a href="?order=name">账号</a></td>
		<td width=150><a href="?order=mac">MAC</a></td>
		<td width=150><a href="?order=deviceid">AndroidID</a></td>
		<td width=100><a href="?order=model">Model</a></td>
		
		<td width=130><a href="?order=ip">IP</a></td>
		<td width=150><a href="?order=region">地区</a></td>
		<td width=80><a href="?order=exp">试用天数</a></td>
